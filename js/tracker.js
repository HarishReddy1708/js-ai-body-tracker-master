  ...
  tracker.isMirrored = true;
        ...
        return new Promise((resolve) => {
            tracker.video.onloadedmetadata = () => {
                ...
                console.log("✅ videoWidth:", tracker.video.videoWidth);
                console.log("✅ videoHeight:", tracker.video.videoHeight);
     ...
     */
        cameraFrame: async function () {
            ...
            if (tracker.video.readyState === tracker.video.HAVE_ENOUGH_DATA) {
                ...
                // Handle iPhone portrait bug (swapped dimensions)
                const isPortrait = window.innerHeight > window.innerWidth;
                if (isPortrait && videoWidth > videoHeight) {
                ...
                // 🪞 Mirror canvas horizontally if front camera
